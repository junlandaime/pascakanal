    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo base_url('admin/lecture') ?>" class="nav-link">
                <i class="fas fa-table nav-icon"></i>
                <p>Data Lecture/Team</p>
              </a>
            </li>
            <!-- <li class="nav-item">
              <a href="<?php echo base_url('admin/lecture/index') ?>" class="nav-link">
                <i class="fas fa-plus nav-icon"></i>
                <p>Tambah Lecture/Team</p>
              </a>
            </li> -->
            <li class="nav-item">
              <a href="<?php echo base_url('admin/kategori_lecture') ?>" class="nav-link">
                <i class="fas fa-tags nav-icon"></i>
                <p>Kategori Lecture/Team</p>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo base_url('admin/kurikulum') ?>" class="nav-link">
                <i class="fas fa-table nav-icon"></i>
                <p>Data Kurikulum</p>
              </a>
            </li>
            <!-- <li class="nav-item">
              <a href="<?php echo base_url('admin/kurikulum/index') ?>" class="nav-link">
                <i class="fas fa-plus nav-icon"></i>
                <p>Tambah kurikulum/Team</p>
              </a>
            </li> -->
            <li class="nav-item">
              <a href="<?php echo base_url('admin/kategori_kurikulum') ?>" class="nav-link">
                <i class="fas fa-tags nav-icon"></i>
                <p>Kategori Kurikulum</p>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <!-- <li class="nav-item">
              <a href="<?php echo base_url('admin/staff/index') ?>" class="nav-link">
                <i class="fas fa-plus nav-icon"></i>
