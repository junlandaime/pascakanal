<main id="main">
  ...
  <?php foreach ($slider as $slide) { ?>
    <?php if ($slide['judul_galeri'] == 'SlideMenu2') { ?>
      ...
      <header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(<?php echo base_url('assets/upload/image/' . $menu_profil[0]['gambar']) ?>);" data-stellar-background-ratio="0.5">
