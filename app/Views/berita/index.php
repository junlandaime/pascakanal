        ...
        <?php foreach ($berita as $berita) { ?>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 d-flex align-items-stretch">
            <div class="fh5co-blog animate-box">
              ...
              <div class="blog-text">
                <h5><a href="<?php echo base_url('berita/read/' . $berita['slug_berita']) ?>"><?php echo $berita['judul_berita'] ?></a></h5>
                <span class="posted_on"><small><?php echo tanggal_bulan_menit($berita['tanggal_publish']) ?></small></span>
                <span class="comment"><a href=""><?php echo $berita['hits'] ?><i class="icon-speech-bubble"></i></a></span>
                <p><small><?php echo $berita['ringkasan'] ?></small></p>
